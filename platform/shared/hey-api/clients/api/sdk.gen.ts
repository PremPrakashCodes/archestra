 ...
 * `chat:update`: Edit chat messages and conversation settings
 */
export const uploadSandboxFile = <ThrowOnError extends boolean = false>(options: Options<UploadSandboxFileData, ThrowOnError>) => (options.client ?? client).post<UploadSandboxFileResponses, UploadSandboxFileErrors, ThrowOnError>({ url: '/api/conversations/{conversationId}/sandbox/upload', ...options });
